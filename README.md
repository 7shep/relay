...
For the feature contracts and operating instructions, see [`docs/feat/`](docs/feat/README.md). The docs cover the `capture-study-session` save flow, the canonical Obsidian archive, and how to interpret Relay's read-only vault graph.
